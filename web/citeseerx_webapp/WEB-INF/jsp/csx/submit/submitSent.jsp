<%@ include file="../shared/IncludeTop2.jsp" %>
 <div id="primary_tabs-n-content" class="clearfix"> <!-- Contains header div -->
  <div id="primary_tabs_container">
   <div id="primary_tabs">
    <ul class="clearfix"><li id="current"><a class="page_tabs remove" href="<c:url value="/submit"/>"><span>Submissions</span></a></li></ul>   <!-- remove extra whitespace by coding in-line lists on one line -->           
  ...
  <div id="primary_content">
   <div id="main_content" class="clearfix">
    <div class="para2 pushdown">
     <h3>Thank you, for your submission and interest in CiteSeer<sup>X</sup>.</h3>
    </div>   
