<%--
  -- This page includes Header information for public pages.
...
<head profile="http://www.w3.org/2005/11/profile http://a9.com/-/spec/opensearch/1.1/">
  ...
  <%-- Used when showing corrections page --%>
  <c:if test="${ true }">
  ...
  <c:if test="${ ! empty pagetitle }">
    <title><fmt:message key="app.name"/> &mdash; <c:out value="${ pagetitle }"/></title>
  </c:if>
