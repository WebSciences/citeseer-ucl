...
<p class="portrait_text para_book">Juan is responsible for the collections feature of MyCiteSeer and general MyCiteSeer bug squashing.  He also participated in developing document conversion routines and contributed in part to the navigation menu design and page layout for CiteSeer<sup>x</sup> and MyCiteSeer<sup>x</sup>.</p>
 </div>                                
 <div class="portrait_container clearfix">
...
<p class="portrait_text para_book">Shuyi scoured the web for millions of new document files and is largely responsible for bringing the CiteSeer<sup>x</sup> collection up to date with the latest literature on the net.</p>
  </div>
 <div class="portrait_container clearfix">
