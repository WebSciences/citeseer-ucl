<%--
  -- Here are the links to Open Search files provided by the system.
  -- All pages which needs to use those links should include these file
  -- This page would be different for every system. Possibly the same for
  -- mirrors.
  --
