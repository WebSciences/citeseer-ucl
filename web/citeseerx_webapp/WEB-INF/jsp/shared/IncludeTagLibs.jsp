...
<%@ page import="edu.psu.citeseerx.myciteseer.domain.MCSConfiguration" %>
<%@ page import="edu.psu.citeseerx.myciteseer.web.utils.MCSUtils" %>

<% 
    MCSConfiguration mscConfig = 
    	MCSUtils.getMyCiteSeer(session.getServletContext()).getConfiguration();
