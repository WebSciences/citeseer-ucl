 ...
 * @see org.apache.commons.collections.comparators.ComparatorChain. If not the
 * collection will be ordered using the items compareTo method.  
 */
public class Paginator {
	...
	/**
	 * Retrieve the page pageNumber from the collection items. If a comparator
