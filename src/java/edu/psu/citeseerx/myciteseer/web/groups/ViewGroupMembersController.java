 ...
 * @version $$Revision: 718 $$ $$Date: 2008-09-30 11:17:40 -0400 (Tue, 30 Sep 2008) $$
 */
public class ViewGroupMembersController implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		try {
	        ...
	        String mSort = 
	        	ServletRequestUtils.getStringParameter(request, "msort", "name");
			String smType = 
				ServletRequestUtils.getStringParameter(request, "smtype", "asc");
