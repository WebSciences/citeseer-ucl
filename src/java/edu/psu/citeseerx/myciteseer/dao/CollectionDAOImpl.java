 ...
 * @version $Rev: 825 $ $Date: 2008-12-18 20:15:19 -0500 (Thu, 18 Dec 2008) $
 */
public class CollectionDAOImpl extends JdbcDaoSupport implements CollectionDAO {
	 ...
	 * @see edu.psu.citeseerx.myciteseer.dao.CollectionDAO#addCollection(edu.psu.citeseerx.myciteseer.domain.Collection)
	 */
	public void addCollection(Collection collection) throws DataAccessException {
	...
	public static final String DEF_GET_COLLECTIONS_QUERY =
		"select id, name, description, UID, deleteAllowed from collections where UID = ?";
	...
	protected class CollectionExistsMapping extends MappingSqlQuery {
		...
		public List run(String name, Account account) {
	...
	protected class GetUserCollectionPapersMapping extends MappingSqlQuery {
		...
		public List run(long collectionID, Account account) {
            Object[] params = new Object[] { collectionID, account.getUsername() };
            return execute(params);
        } //- run
	} //- GetUserCollectionPapersMapping

	public static final String DEF_GET_USER_COLLECTION =
		"select id, name, description, UID, deleteAllowed from collections where" +
		" id = ? and UID = ?";
	...
	public static final String DEF_PAPER_IN_COLLECTION =
		"select CID, PID, UID from papers_in_collection where CID = ? and PID = ? and UID = ?";
	...
	protected class PaperInCollectionMapping extends MappingSqlQuery {
		...
		public List run(PaperCollection paperCollection, Account account) {
            Object[] params = new Object[] {
	...
	public static final String DEF_GET_PAPER_NOTES =
		"select id, CID, PID, UID, note from paper_notes where CID = ? and PID =?";
	...
	protected class GetPaperNotesMapping extends MappingSqlQuery {
		...
		public List run(long collectionID, String paperID) {
	...
	protected class GetCollectionNoteMapping extends MappingSqlQuery {
		...
		public List run(long collectionNoteID, long collectionID, Account account) {
            Object[] params = new Object[] {
            		collectionNoteID,
            		collectionID,
            		account.getUsername()
	...
	public static final String DEF_GET_PAPER_NOTE = 
		"select id, CID, PID, UID, note from paper_notes where id = ? and CID = ? " +
		"and PID = ? and UID = ?";
	...
	protected class GetPaperNoteMapping extends MappingSqlQuery {
		...
		public List run(long paperNoteID, long collectionID, String paperID,
				Account account) {
            Object[] params = new Object[] {
            		paperNoteID,
            		collectionID,
