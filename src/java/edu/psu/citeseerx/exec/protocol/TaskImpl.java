...
public abstract class TaskImpl extends Task {    
    ...
    public void resetMappings() {
        synchronized(inputMapping) {
            for (Enumeration en = inputMapping.keys();
                    en.hasMoreElements(); ) {
        ...
        synchronized(outputMapping) {
            for (Enumeration en = outputMapping.keys();
                    en.hasMoreElements(); ) {
                String key = (String)en.nextElement();
        ...
        synchronized(parameterMapping) {
            for (Enumeration en = parameterMapping.keys();
                    en.hasMoreElements(); ) {
                String key = (String)en.nextElement();
    ...
    protected final ArrayList<Field> requiredInputs = new ArrayList<Field>();
    protected final ArrayList<Field> optionalInputs = new ArrayList<Field>();
    protected final ArrayList<Field> outputs = new ArrayList<Field>();
    protected final ArrayList<Field> parameters = new ArrayList<Field>();
