...
implements CitationStatisticsDAO {
    ...
    public List getMostCitedArticles(int amount, boolean includeCitations)
    ...
    public List getMostCitedArticlesByYear(int amount, int year,
    ...
    public List getAuthorStats(long startingID, int amount)
    throws DataAccessException {
