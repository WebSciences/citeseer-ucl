...
public class DocumentDAOImpl extends JdbcDaoSupport implements DocumentDAO {
    ...
    protected void initMappingSqlQueries() throws ApplicationContextException {
        ...
        setPublic = new SetPublic(getDataSource());
    ...
    public List getDOIs(String start, int amount)
    throws DataAccessException {
    ...
    private class GetDoc extends MappingSqlQuery {
        ...
        public Document mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            doc.setPublic(rs.getBoolean("public"));
    ...
    private class SetPublic extends SqlUpdate {
        
        public SetPublic(DataSource dataSource) {
            setDataSource(dataSource);
        ...
        public int run(Document doc, boolean isPublic) {
            Object[] params = new Object[] {
                    new Boolean(isPublic), doc.getDatum(Document.DOI_KEY)
            };
            return update(params);
        }
    ...
    private class GetDOIs extends MappingSqlQuery {
        ...
        public List run(String start, int amount) {
    ...
    private static final String DEF_GET_SET_DOIS_QUERY =
        ...
        "versionTime <= ? and id > ? order by id asc limit ?";
    ...
    private static final String DEF_GET_SET_DOI_COUNT_QUERY =
        "select count(id) from papers where versionTime > ? and versionTime <= ? and id > ?";
