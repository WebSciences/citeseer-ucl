 ...
 * @version $Rev: 663 $ $Date: 2008-07-27 10:28:51 -0400 (Sun, 27 Jul 2008) $
 */
public class StatisticsGenerator {
    ...
    public void genArticleStats(boolean includeCitations) throws IOException {
        ...
        List docs = citestat.getMostCitedArticles(numArticles,includeCitations);
    ...
    private static void writeDocs(List docs, String fileName)
    throws IOException {
    ...
    public void genAuthorStats() throws IOException {
        ...
        while(true) {
            start = start+1;
            List authorStats = citestat.getAuthorStats(start, batch);
    ...
    private static void writeAuthStats(List authorStats, String fileName)
    throws IOException {
