...
import edu.psu.citeseerx.dao.CSXDAO;
...
public class IngestWorker implements Runnable {
     ...
     * @param repositoryID location of remote file resources
     * @param filePath path in remote repository to ingest file
     * @param manager parent Object
     */
